...
public:
    ...
    el_sem(SEXP y_r, SEXP b_r, SEXP omega_r, SEXP b_weights_r, SEXP omega_weights_r, SEXP d_r, SEXP lambda_r, SEXP gamma_r, int v_r);
...
protected:
    ...
    mat omega_weights_; //matrix of bidirected edge weights
