...
// sem_el_fitC
double sem_el_fitC(SEXP y_r, SEXP b_r, SEXP omega_r, SEXP b_weightsr, SEXP omega_weights_r, SEXP d_r, SEXP lambda_r, SEXP gamma_r, int v, double tol, int max_iter);
RcppExport SEXP BCD_sem_el_fitC(SEXP y_rSEXP, SEXP b_rSEXP, SEXP omega_rSEXP, SEXP b_weightsrSEXP, SEXP omega_weights_rSEXP, SEXP d_rSEXP, SEXP lambda_rSEXP, SEXP gamma_rSEXP, SEXP vSEXP, SEXP tolSEXP, SEXP max_iterSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< SEXP >::type b_weightsr(b_weightsrSEXP);
    ...
    __result = Rcpp::wrap(sem_el_fitC(y_r, b_r, omega_r, b_weightsr, omega_weights_r, d_r, lambda_r, gamma_r, v, tol, max_iter));
    return __result;
END_RCPP
}
