...
{
public:
el_sem_fixed(SEXP b_weights_r, SEXP y_r,SEXP b_r, SEXP moment_2_restrictions_r, SEXP moment_3_restrictions_r, int meanEst, double b_fixed, int row_ind, int col_ind);
